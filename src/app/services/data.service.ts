...
export class DataService {
  ...
  constructor() {
    ...
    this.geojson = [
      ...
      { "id": 6, "name": "Fuente del Túria", "audio": "fuente_turia.m4a", "image":"fuente_turia.jpg", "question": "When do the tribunal de les aigües reunite every week?", "answers": [ { "Saturday": true }, { "Sunday": false }, { "Wednesday": false } ] , "geometry": { "type": "Point", "coordinates": [ -0.375279286584046, 39.476383983295925, 0.0 ] } },
      { "id": 7, "name": "Casa Punto de Gancho", "audio": "casa_gancho.m4a", "image":"casa_gancho.jpg", "question": "Who founded valencia near the croché house, more than two thousand years ago?", "answers": [ { "Muslims": false }, { "Romans": true }, { "Medieval Christians": false } ] , "geometry": { "type": "Point", "coordinates": [ -0.374372702697458, 39.475911442023886, 0.0 ] } },
      ...
      { "id": 13, "name": "Plaza de Toros de Valencia", "audio": "plaza_toros.m4a", "image":"plaza_toros.jpg", "question": "How many people fit the bullfighting square?", "answers": [ { "8000": false }, { "20000": false }, { "12000": true }, { "14000": false } ] , "geometry": { "type": "Point", "coordinates": [ -0.375965194652662, 39.467078137888684, 0.0 ] } }
    ]
