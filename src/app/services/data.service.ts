...
export class DataService {
  ...
  constructor(private storage: StorageService, private toastCtrl: ToastController) {
    ...
    this.geojson = [
      ...
      { "id": 4, "name": "Calle Serranos", "audio": "serranos.aac", "image":"serranos.jpg", "question": "In what year did Jaime I took the city of Valencia?", "answers": [ { "1123": false }, { "1453": false }, { "1238": true } ] , "geometry": { "type": "Point", "coordinates": [ -0.376622734649902, 39.478008625269823, 0.0 ] } },
      ...
      { "id": 7, "name": "Casa Punto de Gancho", "audio": "casa_gancho.aac", "image":"casa_gancho.jpg", "question": "Who founded valencia near the croché house, more than two thousand years ago?", "answers": [ { "Muslims": false }, { "Romans": true }, { "Medieval Christians": false } ] , "geometry": { "type": "Point", "coordinates": [ -0.374372702697458, 39.475911442023886, 0.0 ] } },
      { "id": 8, "name": "Plaza de la Reina", "audio": "plaza_reina.aac", "image":"plaza_reina.jpg", "question": "What was the micalet origin?", "answers": [ { "It was a Christian tower": false }, { "it was a tower built in the XX century": false }, { "It was the minaret of the ancient islamic mosque": true }, {"It was a roman defense tower":false} ] , "geometry": { "type": "Point", "coordinates": [ -0.3754669, 39.4746454, 0.0 ] } },
      { "id": 9, "name": "Plaza Redonda", "audio": "plaza_redonda.aac", "image":"plaza_redonda.jpg", "question": "Towards which directions are the accesses of the plaza redonda oriented?", "answers": [ { "All four cardinal directions": true }, { "North and East": false }, { "South and West": false }, { "North and South": false }] , "geometry": { "type": "Point", "coordinates": [ -0.376527, 39.4736692, 0.0 ] } },
