...
export class DataService {
  ...
  constructor() {
    ...
    this.geojson = [
      ...
      { "id": 4, "name": "Calle Serranos", "audio": "serranos.m4a", "image":"serranos.jpg", "question": "In what year did Jaime I took the city of Valencia?", "answers": [ { "1123": false }, { "1453": false }, { "1238": true } ] , "geometry": { "type": "Point", "coordinates": [ -0.376622734649902, 39.478008625269823, 0.0 ] } },
      { "id": 5, "name": "Plaza de Manises", "audio": "manises.m4a", "image":"plaza_manises.jpg", "question": "In what year was the Palace built?", "answers": [ { "1541": false }, { "1421": true }, { "1810": false } ] , "geometry": { "type": "Point", "coordinates": [ -0.3765453, 39.4768211, 0.0 ] } },
      { "id": 6, "name": "Fuente del Túria", "audio": "fuente_turia.m4a", "image":"fuente_turia.jpg", "question": "When do the tribunal de les aigües reunite every week?", "answers": [ { "Saturday": true }, { "Sunday": false }, { "Wednesday": false } ] , "geometry": { "type": "Point", "coordinates": [ -0.3752762, 39.476482399999988, 0.0 ] } },
      { "id": 7, "name": "Casa Punto de Gancho", "audio": "casa_gancho.m4a", "image":"casa_gancho.jpg", "question": "Who founded valencia near the croché house, more than two thousand years ago?", "answers": [ { "Muslims": false }, { "Romans": true }, { "Medieval Christians": false } ] , "geometry": { "type": "Point", "coordinates": [ -0.3742942, 39.475918, 0.0 ] } },
      { "id": 8, "name": "Plaza de la Reina", "audio": "plaza_reina.m4a", "image":"plaza_reina.jpg", "question": "What was the micalet origin?", "answers": [ { "It was a Christian tower": false }, { "it was a tower built in the XX century": false }, { "It was the minaret of the ancient islamic mosque": true }, {"It was a roman defense tower":false} ] , "geometry": { "type": "Point", "coordinates": [ -0.3754669, 39.4746454, 0.0 ] } },
      { "id": 9, "name": "Plaza Redonda", "audio": "plaza_redonda.m4a", "image":"plaza_redonda.jpg", "question": "To what direction are the accesses of the square directed?", "answers": [ { "All four cardinal directions": true }, { "North and East": false }, { "South and West": false }, { "North and South": false }] , "geometry": { "type": "Point", "coordinates": [ -0.376527, 39.4736692, 0.0 ] } },
      ...
      { "id": 13, "name": "Plaza de Toros de Valencia", "audio": "plaza_toros.m4a", "image":"plaza_toros.jpg", "question": "How many people fit the bullfighting square?", "answers": [ { "8000": false }, { "20000": false }, { "12000": true }, { "14000": false } ] , "geometry": { "type": "Point", "coordinates": [ -0.3761198, 39.4666255, 0.0 ] } }
    ]
